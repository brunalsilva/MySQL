...
insert into tb_categoria(secao,estoque,delivery) values ("Congelados",true,true);
insert into tb_categoria(secao,estoque,delivery) values ("Congelados",false,true);
insert into tb_categoria(secao,estoque,delivery) values ("Frescos",true,true);
insert into tb_categoria(secao,estoque,delivery) values ("Frescos",true,false);
insert into tb_categoria(secao,estoque,delivery) values ("Frescos",false,false);
